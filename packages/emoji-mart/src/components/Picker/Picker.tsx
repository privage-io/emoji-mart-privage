  ...
  renderSkinToneButton() {
    ...
    return (
      ...
      >
        ...
        >
          {this.props.skinToneEmoji ? <span style={{ fontSize: this.props.emojiSize }}>{typeof this.props.skinToneEmoji === "object" ? this.props.skinToneEmoji[this.state.skin] : this.props.skinToneEmoji}</span> : <span class={`skin-tone skin-tone-${this.state.skin}`}></span>}
        </button>
      </div>
    )
  }
        ...
        {[...Array(6).keys()].map((i) => {
          ...
          return (
            <div>
              ...
              >
                {this.props.skinToneEmoji ? <span style={{ fontSize: "1.2em" }}>{typeof this.props.skinToneEmoji === "object" ? this.props.skinToneEmoji[skin] : this.props.skinToneEmoji}</span> : <span class={`skin-tone skin-tone-${skin}`}></span>}
