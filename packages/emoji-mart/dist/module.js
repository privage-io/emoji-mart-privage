...
function $fb96b826c0c5f37a$var$j(n, u, i, t, r, o, f, e, c) {
    ...
    try {
        ...
        u.__v = null, (c || null != o) && (u.__e = e, u.__h = !!c, o[o.indexOf(e)] = null), $fb96b826c0c5f37a$export$41c562ebe57d11e2.__e(n, u, i);
    }
}
...
function $fb96b826c0c5f37a$var$M(n, u, i) {
    try {
        ...
        $fb96b826c0c5f37a$export$41c562ebe57d11e2.__e(n, i);
    }
}
...
let $b22cfd0a55410b4f$var$Skins = null;
function $b22cfd0a55410b4f$var$add(emoji) {
    ...
    $b22cfd0a55410b4f$var$Skins || ($b22cfd0a55410b4f$var$Skins = (0, $f72b75cf796873c7$export$2e2bcd8739ae039).get('skins') || {});
    const emojiId = emoji.id || emoji;
    if (!emojiId) return;
    $b22cfd0a55410b4f$var$Index[emojiId] || ($b22cfd0a55410b4f$var$Index[emojiId] = 0);
    $b22cfd0a55410b4f$var$Index[emojiId] += 1;
    emoji.skin && ($b22cfd0a55410b4f$var$Skins[emojiId] = emoji.skin);
    ...
    (0, $f72b75cf796873c7$export$2e2bcd8739ae039).set('skins', $b22cfd0a55410b4f$var$Skins);
}
function $b22cfd0a55410b4f$var$get({ maxFrequentRows: maxFrequentRows, perLine: perLine }) {
    ...
    if (emojiIds.length > max) {
        ...
        for (let removedId of removedIds){
            ...
            delete $b22cfd0a55410b4f$var$Skins[removedId];
        }
        if (last && emojiIds.indexOf(last) == -1) {
            delete $b22cfd0a55410b4f$var$Index[emojiIds[emojiIds.length - 1]];
            delete $b22cfd0a55410b4f$var$Skins[emojiIds[emojiIds.length - 1]];
...
function $b22cfd0a55410b4f$var$getSkin(emojiId) {
    return $b22cfd0a55410b4f$var$Skins[emojiId];
}
var $b22cfd0a55410b4f$export$2e2bcd8739ae039 = {
    add: $b22cfd0a55410b4f$var$add,
    get: $b22cfd0a55410b4f$var$get,
    getSkin: $b22cfd0a55410b4f$var$getSkin,
...
async function $7adb23b0109cc36a$var$_init(props) {
    ...
    if (!$7adb23b0109cc36a$export$2d0294657ab35f1b) {
        ...
        for (const id of Object.keys($7adb23b0109cc36a$export$2d0294657ab35f1b.emojis))if (!originalIds.has(id)) delete $7adb23b0109cc36a$export$2d0294657ab35f1b.emojis[id];
...
const $254755d3f438722f$var$TRANSPARENT_GIF = 'data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7';
function $254755d3f438722f$export$2e2bcd8739ae039(props) {
    ...
    return /*#__PURE__*/ (0, $bd9dd35321b03dd4$export$34b9dba7ce09269b)((0, $fb96b826c0c5f37a$export$ffb0004e005737fa), {
        children: props.set == 'native' ? /*#__PURE__*/ (0, $bd9dd35321b03dd4$export$34b9dba7ce09269b)("span", {
            style: {
                fontSize: props.size,
            ...
            style: {
                ...
                backgroundSize: emojiSkin.src ? undefined : `${100 * (0, $7adb23b0109cc36a$export$2d0294657ab35f1b).sheet.cols}% ${100 * (0, $7adb23b0109cc36a$export$2d0294657ab35f1b).sheet.rows}%`,
                backgroundPosition: emojiSkin.src ? undefined : `${100 / ((0, $7adb23b0109cc36a$export$2d0294657ab35f1b).sheet.cols - 1) * emojiSkin.x}% ${100 / ((0, $7adb23b0109cc36a$export$2d0294657ab35f1b).sheet.rows - 1) * emojiSkin.y}%`,
                userSelect: 'text',
                MozUserDrag: 'none',
                WebkitUserDrag: 'none',
                msUserDrag: 'none',
            ...
            src: imageSrc || $254755d3f438722f$var$TRANSPARENT_GIF
        })
    });
}
...
var $3d90f6e46fb2dd47$export$2e2bcd8739ae039 = {
    ...
    getSpritesheetURL: (0, $b247ea80b67298d5$export$2e2bcd8739ae039).getSpritesheetURL,
    // Shared
    set: (0, $b247ea80b67298d5$export$2e2bcd8739ae039).set,
    skin: {
        value: null,
        choices: (0, $b247ea80b67298d5$export$2e2bcd8739ae039).skin.choices
    }
};
...
class $89bd6bb200cc8fef$export$2e2bcd8739ae039 extends (0, $fb96b826c0c5f37a$export$16fa2f45be04daa8) {
    ...
    handleEmojiClick({ e: e, emoji: emoji, pos: pos, skin: skin }) {
        ...
        if (!emoji && pos) {
            ...
            skin = (0, $b22cfd0a55410b4f$export$2e2bcd8739ae039).getSkin(emoji?.id) || this.state.tempSkin || this.state.skin;
        }
        if (emoji) {
                    ...
                    children: [
                        /*#__PURE__*/ (0, $bd9dd35321b03dd4$export$34b9dba7ce09269b)("div", {
                            ...
                            children: [
                                ...
                                collapsible && /*#__PURE__*/ (0, $bd9dd35321b03dd4$export$34b9dba7ce09269b)("span", {
    ...
    renderSkinToneButton() {
        ...
        return /*#__PURE__*/ (0, $bd9dd35321b03dd4$export$34b9dba7ce09269b)("div", {
            ...
            children: /*#__PURE__*/ (0, $bd9dd35321b03dd4$export$34b9dba7ce09269b)("button", {
                ...
                children: this.props.skinToneEmoji ? /*#__PURE__*/ (0, $bd9dd35321b03dd4$export$34b9dba7ce09269b)("span", {
                    style: {
                        fontSize: this.props.emojiSize
                    },
                ...
                return /*#__PURE__*/ (0, $bd9dd35321b03dd4$export$34b9dba7ce09269b)("div", {
                    children: [
                        ...
                        /*#__PURE__*/ (0, $bd9dd35321b03dd4$export$34b9dba7ce09269b)("button", {
                            ...
                            children: [
                                this.props.skinToneEmoji ? /*#__PURE__*/ (0, $bd9dd35321b03dd4$export$34b9dba7ce09269b)("span", {
                                    style: {
                                        fontSize: "1.2em"
                                    },
    ...
    render() {
        ...
        return /*#__PURE__*/ (0, $bd9dd35321b03dd4$export$34b9dba7ce09269b)("section", {
            ...
            children: [
                ...
                (this.props.searchPosition == 'sticky' || this.props.searchPosition == 'hidden') && /*#__PURE__*/ (0, $bd9dd35321b03dd4$export$34b9dba7ce09269b)("div", {
                    class: "padding-lr",
...
class $efa000751917694d$export$2e2bcd8739ae039 extends (0, $26f27c338a96b1a6$export$2e2bcd8739ae039) {
    static{
        this.Props = (0, $b247ea80b67298d5$export$2e2bcd8739ae039);
    }
    constructor(props){
        super(props, {
